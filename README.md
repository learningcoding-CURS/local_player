...
| **按钮间距可调** | 跳转按钮（前进/后退）与播放按钮之间的间距、切换按钮（上一首/下一首）之间的间距，均可在设置中调节（0–80 dp / 0–150 dp） |
...
| `skip_btn_spacing` | int | 64 | 切换按钮间距（0–150 dp） |
| `seek_offset_y` | int | 0 | 跳转按钮垂直偏移（-800 ~ +800 dp） |
| `seek_btn_spacing` | int | 24 | 跳转按钮间距（0–80 dp） |
...
| 设置项 | 范围 | 默认值 | 说明 |
|--------|------|--------|------|
| 跳转按钮间距 | 0–80 dp | 24 dp | 前进/后退按钮与播放按钮之间的间距 |
| 切换按钮间距 | 0–150 dp | 64 dp | 上一首/下一首按钮之间的间距 |
