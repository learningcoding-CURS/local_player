...
public final class ItemVideoListBinding implements ViewBinding {
  ...
  private ItemVideoListBinding(@NonNull CardView rootView, @NonNull ImageView imgThumbnail,
  ...
  public static ItemVideoListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemVideoListBinding((CardView) rootView, imgThumbnail, imgThumbnailFallback,
